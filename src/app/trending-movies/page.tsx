...
export default async function TopRatedPage() {
    const moviesData = await fetchTrendingMovies(1);

    return (
        <div className="max-w-7xl mx-auto px-4 pb-5">
            <section className="mt-20 mb-3 flex flex-col sm:flex-row sm:justify-between sm:items-center">
                <h1 className="text-3xl mb-2 sm:mb-0">Trending Movies</h1>
